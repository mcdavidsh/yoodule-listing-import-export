...
if (!function_exists('yoodule_admin_menu')) {
	function yoodule_admin_menu() {
		...
		$menu_title = 'Yoodule Listing Import Exportn';
        ...
        add_submenu_page( $menu_slug, 'Manage Everything', 'Manage Accomodation', 'manage_options', 'manage-yts-accomodat', 'yoodule_sub_manage' );
	}
}
